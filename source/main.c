...
{
    //PLAN
    // load image, texcoords are filesize / frames, todo check how animated frams work in gl2d
}
...
int main(void)
{
    ...
    while (!WindowShouldClose())
    {
        ...
        glSprite(50, 50, GL_FLIP_NONE, &sprite.image[0]);
